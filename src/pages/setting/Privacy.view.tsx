    ...
    <div className="help">
      ...
      <div className="help-content">
        <div className="con">
          ...
          <p className="pleft">1. 适用范围</p>
          <p className="pleft">(a) 在您注册本应用帐号时，您根据本应用要求提供的个人注册信息；</p>
          <p className="pleft">
            (b)
            在您使用本应用网络服务，或访问本应用平台网页时，本应用自动接收并记录的您的浏览器和计算机上的信息，包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；
          </p>
          <p className="pleft">(c) 本应用通过合法途径从商业伙伴处取得的用户个人数据。</p>
          <p className="pleft">您了解并同意，以下信息不适用本隐私权政策：</p>
          <p className="pleft">(a) 您在使用本应用平台提供的搜索服务时输入的关键字信息；</p>
          <p className="pleft">
            (b) 本应用收集到的您在本应用发布的有关信息数据，包括但不限于参与活动、成交信息及评价详情；
          </p>
          <p className="pleft">(c) 违反法律规定或违反本应用规则行为及本应用已对您采取的措施。</p>
          <p className="pleft">2. 信息使用</p>
          <p className="pleft">
          ...
          <p className="pleft">3. 信息披露</p>
          <p className="pleft">在如下情况下，本应用将依据您的个人意愿或法律的规定全部或部分的披露您的个人信息：</p>
          <p className="pleft">(a) 经您事先同意，向第三方披露；</p>
          <p className="pleft">(b)为提供您所要求的产品和服务，而必须和第三方分享您的个人信息；</p>
          <p className="pleft">(c) 根据法律的有关规定，或者行政或司法机构的要求，向第三方或者行政、司法机构披露；</p>
          <p className="pleft">
          ...
          <p className="pleft">(g) 其它本应用根据法律、法规或者网站政策认为合适的披露。</p>
          <p className="pleft">4. 信息存储和交换</p>
          <p className="pleft">
            本应用收集的有关您的信息和资料将保存在本应用及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或本应用收集信息和资料所在地的境外并在境外被访问、存储和展示。
          </p>
          <p className="pleft">5. Cookie的使用</p>
          <p className="pleft">
          ...
          <p className="pleft">(c) 通过本应用所设cookies所取得的有关信息，将适用本政策。</p>
          <p className="pleft">6. 信息安全</p>
          <p className="pleft">
            (a)
